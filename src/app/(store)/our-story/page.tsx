        ...
        <div className="bg-white min-h-screen pt-24 pb-12">
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="text-center mb-16 animate-fade-in-up">
                    <h1 className="text-4xl md:text-6xl font-heading font-bold text-black mb-6">
                ...
                <div className="space-y-12">
                    <section className="prose prose-lg max-w-none text-black">
                        <p className="text-lg leading-loose">
                            In the bustling heart of Karnataka, a young visionary named <strong className="text-neon-blue">Rahul Reddy</strong> embarked on a remarkable journey. Driven by a passion for precision and an eye for aesthetics, Rahul saw a gap in the eyewear industry—a disconnect between clinical necessity and personal style.
                        </p>

                        <p className="text-lg leading-loose">
                            He believed that glasses shouldn't just be a medical device; they should be an extension of one's personality. With this philosophy, Rahul set out to create <strong className="text-black">Lens&Look</strong>, a brand that marries cutting-edge optical technology with high-fashion design.
                        </p>
                    </section>

                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 my-12">
                        <div className="bg-gray-50 p-8 rounded-2xl border border-gray-100">
                            <h3 className="text-2xl font-bold text-black mb-4">The Mission</h3>
